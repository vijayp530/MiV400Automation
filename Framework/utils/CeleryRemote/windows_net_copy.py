...
def netcopy(host, source, dest_dir, username=None, password=None, move=False):
    ...
    print(wnet_connect(host, username, password))
...
def netcopy_dir(host, source_dir, dest_dir, username=None, password=None, move=False):
    """ Copies all files and directories present in source_dir to a remote computer. """
    print(host, username, password)
    print(wnet_connect(host, username, password))
    start_time = time.time()
    source = covert_unc(host, source_dir)
...
#    netcopy('10.198.107.18', r'C:\Shoreline Data\keystore\ssh\hq_rsa', r'C:\StafAutomation', 'administrator', 'Shoreadmin1')
#    netcopy('10.198.107.18', r'C:\Shoreline Data\keystore\ssh\hq_rsa.pub', r'C:\StafAutomation', 'administrator', 'Shoreadmin1')
    # netcopy('10.198.107.18', r'C:\Shoreline Data\Logs\TmsMain-160201.000000.Log', r'C:\test', 'administrator', 'Shoreadmin1')
